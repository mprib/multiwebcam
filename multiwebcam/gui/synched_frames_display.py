...
from multiwebcam.gui.frame_emitters.frame_dictionary_emitter import FrameDictionaryEmitter
from multiwebcam.synchronized_stream_manager import SynchronizedStreamManager
